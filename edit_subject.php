            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Update Subject Management</li>
                    </ol>
                </div>
            </div>
                                ...
                                <div class="input-states">
                                   ...
                                   <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                  <input type="text" name="coursecode" class="form-control" placeholder="Course Code" id="event" required="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                  <input type="number" name="credit" class="form-control" placeholder="Credit" id="event" onkeydown="return alphaOnly(event);" required="">
                                                </div>
                                            </div>
                                        </div>
