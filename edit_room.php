...
$q1 = "SELECT * FROM `room_type` WHERE id=$id";
$query=$conn->query($q1);
    ...
    <div class="row">
        ...
        <div class="col-sm-9">
            <select name="roomtype" class="form-control" required="">
                ...
                <?php  
                $q1 = "SELECT * FROM `room_type`";
                $result = $conn->query($q1);

                if ($result->num_rows > 0) {
                    while ($row = mysqli_fetch_array($result)) {
                        $selected = ($roomtype == $row['id']) ? 'selected' : ''; // Ensure the correct type is selected
    ...
    <div class="row">
        ...
        <div class="col-sm-9">
            <select name="roomname" class="form-control" required="">
                ...
                if ($result->num_rows > 0) {
                    while ($row = mysqli_fetch_array($result)) {
                        $selected = ($roomname == $row['roomname']) ? 'selected' : ''; // Ensure the correct name is selected
                ...
                ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                  <input type="number" min="0" name="strength" class="form-control" placeholder="Capacity" required="">
                                                </div>
                                            </div>
                                        </div>
